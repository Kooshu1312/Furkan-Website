  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-display text-4xl font-bold mb-6">
              Expert Car Care in Mukherjee Nagar
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              With years of experience serving the community, we provide honest,
              reliable, and affordable car repair services. From routine
              maintenance to complex repairs, our skilled technicians are here
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-display text-4xl font-bold text-center mb-12">
            Our Services
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-sm opacity-80">
                No hidden charges. Transparent quotes before we start.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm opacity-80">
                We stand behind our work with satisfaction guaranteed.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-card p-8 rounded-lg border border-border">
              ...
              <a href="tel:+919999067526" className="text-primary font-semibold hover:underline">
                +91 99990 67526
              </a>
            </div>
          </div>
          ...
          <div className="mt-8 max-w-5xl mx-auto">
            <div className="bg-card p-4 rounded-lg border border-border">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.2841763576436!2d77.2090212!3d28.6139391"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen
